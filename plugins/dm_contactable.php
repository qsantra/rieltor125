...
//	register_script('contactable-validate', $SITEURL.'plugins/DM_contactable/js/jquery.validate.pack.js', '1.5.1', FALSE); - из-за этого скрипта не работает fancybox (заменил другим)
	register_script('contactable-validate', $SITEURL.'plugins/DM_contactable/js/jquery.validate.min.js', '1.5.1', FALSE);
