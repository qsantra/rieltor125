...
$i18n = array (
	...
	"SC_DESC" => "Simple contact form plugin for GetSimple",
        ...
        "SC_FE_ATTACHMENT" => "Your attachment (up to 2 mb): .doc, .docx, .xls, .xlsx, .ppt, .pptx, .pps, .ppsx, .odt, .pdf, .bmp, .gif, .jpg, .jpeg, .png, .zip, .rar:",
        "SC_FE_ATTACHMENT_NAME" => "attachment",
        "SC_FE_ATTACHMENT_TYPE_DISABLED" => "The attached file type is not allowed.",
        "SC_FE_ATTACHMENT_SIZE_EXCEEDED" => "The attached file size exceeded maximum filesize (2MB).",
