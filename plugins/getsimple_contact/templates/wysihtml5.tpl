<div id="toolbar" style="display: none;">
    ...
    <div data-wysihtml5-dialog="createLink" class="sc-insert-link-container" style="display: none;">
        ...
        <label class="sc-label"><input data-wysihtml5-dialog-field="href" value="http://" class="sc-text"></label>
    ...
    <div data-wysihtml5-dialog="insertImage" style="display: none;">
        ...
        <label class="sc-label"><input data-wysihtml5-dialog-field="src" value="http://" class="sc-text"></label>
        <label class="sc-label">
            <select data-wysihtml5-dialog-field="className" class="sc-select">
