CKEDITOR.plugins.setLang('youtube', 'ru', {
	...
	txtEmbed : 'Вставьте HTML-код сюда (видео не будет адаптивным)',
	txtUrl : 'Вставьте адрес видео (URL, видео можно сделать адаптивным)',
	txtWidth : 'Ширина',
	txtHeight : 'Высота',
	...
	txtResponsive : 'Адаптивное видео (если используется Bootstrap)'
});
